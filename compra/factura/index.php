  ...
  <body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Factura de compra</h1>
            ...
            <div class="card">
                <div class="card-header p-0">
                    <ul class="nav nav-pills ml-auto p-2">
                        <li class="nav-item"><a class="nav-link active" href="#panel-factura" id="btn-panel-factura" data-toggle="tab">factura</a></li>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane active" id="panel-factura">
                            <label class="text-danger">
                                <i class="fa fa-exclamation-circle"></i> Lista de Facturas 
                            </label>
                        </div>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2021 <a href="#">informatica</a></strong>
      </footer>
    </div>
