...
<?php
    ...
    $proveedores = pg_fetch_all(pg_query($conexion, "SELECT * FROM v_proveedores WHERE estado = 'ACTIVO' ORDER BY per_nombre"));
?>
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <select class="select2" id="id_pro">
                ...
                <option value="<?php echo $pr['id_pro']; ?>"><?php echo $pr['per_nombre'].""; ?></option>
                <?php } ?>
            </select>
        </div>
        <div class="form-group">
        ...
        <div class="card-body">
            ...
            <?php if(!empty($presupuestos_detalles)){ ?>
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <?php $total = 0; foreach($presupuestos_detalles as $d){ $total = $total + ($d['precio'] * $d['cantidad']); ?>                            <tr>
