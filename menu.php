...
<aside class="<?php echo $_SESSION['color_menu'];?>">
  <a href="/tercero/inicio.php" class="<?php echo $_SESSION['color_logo'];?>">
    <img src="/tercero/iconos/informatic.jpg" alt="LOGO" class="brand-image img-circle elevation-5">
    <span class="brand-text text-white">MENU</span>
  </a>
  <div class="sidebar">
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a class="d-block">
          <?= $_SESSION['per_nombre']." ".$_SESSION['per_apellido'];?><br>
          <span class="text-muted">(<?= $_SESSION['gru_descrip'];?>)</span>
        </a>
      </div>
    </div>
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        <a class="d-block">
          <?php echo $_SESSION['suc_abreviacion'];?>
        </a>
      </div>
    </div>
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        <?php if(!empty($p1)){foreach($modulos as $m){ ?>
        ...
        <?php } }else{ ?>
          <label class ="text-warning"><i class="fa fa-exclamation-circle"></i>No posee ningun permiso...</label>
        <?php } ?>
      </ul>
    </nav>
  </div>
