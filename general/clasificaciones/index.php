...
<html>
    <head>
        ...
        <link rel="icon" href="/tercero/iconos/camaleon.jpg" type="jpg">
            ...
            <div class="content-wrapper">
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1 class="m-0 text-dark">CLASIFICACIONES</h1>
                            </div>
                            <div class="col-sm-6">
                ...
                <section class="content">
                    <input type="hidden" id="tecla_presionada" value="">
                    <div class="card">
                        <div class="card-header">
                            <button type="button" class="btn btn-success" onclick="agregar();">
                                <i class="fas fa-plus-circle"></i> Agregar Clasificacion
                            </button>
                            <input type="hidden" id="operacion" value="0">
                            <input type="hidden" id="id_cla" value="0">
