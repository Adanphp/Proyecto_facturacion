  ...
  <body class="hold-transition sidebar-mini layout-fixed sidebar-collapse">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0 text-dark">Registrar Reservas</h1>
                <input type="hidden" id="operacion" value="0">
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                  <li class="breadcrumb-item active">Servicios</li>
                  <li class="breadcrumb-item active">Registrar Reservas</li>
                </ol>
              </div>
            </div>
          </div>
            ...
            <div class="card">
                <div class="card-header p-0">
                    <ul class="nav nav-pills ml-auto p-2">
                        <li class= "nav-item"><a class="nav-link active" href="#panel-reserva" id="btn-panel-reserva" data-toggle="tab">Reservas</a></li> 
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="panel-reserva">
                            <label class="text-danger">
                                <i class="fa fa-exclamation-circle"></i>Lista de Reservas 
                            </label>                        
                        </div>
      ...
      <footer class="main-footer">
        <strong>Copyright &copy; 2021 <a href="#">Tercero</a></strong>
      </footer>
    </div>
